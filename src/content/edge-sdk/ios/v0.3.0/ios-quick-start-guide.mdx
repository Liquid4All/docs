...
4. Select the latest version (0.3.0+)
5. Add **both** `LeapSDK` and `LeapSDKTypes` products to your target

<Callout type="important">
  Starting with version 0.3.0, you must add both `LeapSDK` and `LeapSDKTypes` products to your
...
<Callout type="important">
  Both XCFrameworks are required starting with version 0.3.0. Make sure to add and embed both
