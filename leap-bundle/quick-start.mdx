...
:::warning[Compatability Note]
The Model Bundling Service will work with any finetuned model, as long as the model architecture comes from a base model that is part of the LEAP model library.
:::
