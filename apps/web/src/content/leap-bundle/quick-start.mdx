# Model Bundle Tool Quick Start

Model Bundle Tool is a command-line utility for creating and managing model bundles based on custom LEAP model checkpoints. This guide will help you quickly get started with the tool.
...
4. Authenticate the Model Bundle Tool with your API token:
...
You can logout to clear your stored credentials:
