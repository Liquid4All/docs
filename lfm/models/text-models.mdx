...
<Card title="LFM2.5-1.2B-Base" href="/lfm/models/lfm25-1.2b-base">
  ...
  Pre-trained checkpoint for continued pre-training, fine-tuning, and custom models.
</Card>
...
<Card title="LFM2.5-230M" href="/lfm/models/lfm25-230m">
  230M · <Badge shape="pill" color="yellow">Smallest</Badge>
