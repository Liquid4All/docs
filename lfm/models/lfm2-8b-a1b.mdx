---
title: "LFM2-8B-A1B"
description: "8B parameter Mixture-of-Experts model with 1.5B active parameters (deprecated - use LFM2.5-8B-A1B instead)"
---
...
<Tabs>
  ...
  <Tab title="SGLang">
    <TextSglang modelId="LiquidAI/LFM2-8B-A1B" toolCallParser="lfm2"></TextSglang>
  </Tab>
</Tabs>
