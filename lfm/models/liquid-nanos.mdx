...
<Card title="LFM2.5-Encoder-230M" href="/lfm/models/lfm25-encoder-230m">
  230M · <Badge shape="pill" color="orange">Encoder</Badge>

  Compact bidirectional encoder for the tightest latency and memory budgets.
</Card>

<Card title="LFM2.5-Encoder-350M" href="/lfm/models/lfm25-encoder-350m">
  350M · <Badge shape="pill" color="orange">Encoder</Badge>
