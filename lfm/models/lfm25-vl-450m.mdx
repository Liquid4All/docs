...
description: "Compact 450M vision-language model with enhanced performance for edge deployment"
---
...
<Tabs>
  <Tab title="Transformers">
    <VlTransformers modelId="LiquidAI/LFM2.5-VL-450M"></VlTransformers>
  </Tab>
  <Tab title="vLLM">
    <VlVllm modelId="LiquidAI/LFM2.5-VL-450M"></VlVllm>
  </Tab>
  <Tab title="SGLang">
    <VlSglang modelId="LiquidAI/LFM2.5-VL-450M"></VlSglang>
  </Tab>
  <Tab title="llama.cpp">
    <VlLlamacpp ggufRepo="LiquidAI/LFM2.5-VL-450M-GGUF" samplingFlags="--temp 0.1 --min-p 0.15 --repeat-penalty 1.05"></VlLlamacpp>
  </Tab>
</Tabs>
