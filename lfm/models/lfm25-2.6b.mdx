...
<Tabs>
  <Tab title="Transformers">
    <TextTransformers modelId="LiquidAI/LFM2.5-2.6B" samplingParams="do_sample=True, temperature=0.1, top_k=50, repetition_penalty=1.1, "></TextTransformers>
  </Tab>
  <Tab title="llama.cpp">
    <TextLlamacpp ggufRepo="LiquidAI/LFM2.5-2.6B-GGUF" samplingFlags="--temp 0.1 --top-k 50 --repeat-penalty 1.1"></TextLlamacpp>
  </Tab>
  <Tab title="vLLM">
    <TextVllm modelId="LiquidAI/LFM2.5-2.6B" samplingParams="temperature=0.1, top_k=50, repetition_penalty=1.1, " maxTokens="8192"></TextVllm>
  </Tab>
  <Tab title="SGLang">
    <TextSglang modelId="LiquidAI/LFM2.5-2.6B" toolCallParser="lfm2" samplingParams={'temperature=0.1,\n    extra_body={"top_k": 50, "repetition_penalty": 1.1},'}></TextSglang>
  </Tab>
</Tabs>
