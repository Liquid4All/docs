---
title: "LFM2.5-VL-450M-Extract"
description: "Compact vision extraction Nano for structured JSON extraction from images"
---

<a href="/lfm/models/liquid-nanos" className="back-button">← Back to Liquid Nanos</a>

LFM2.5-VL-450M-Extract is the compact vision extraction Nano for turning images into structured JSON. It uses the same YAML-schema prompting pattern as the larger VL Extract model while keeping the deployment footprint small.

<div style={{display: 'flex', gap: '0.5rem', margin: '0.5rem 0 1.5rem 0'}}>
  <a href="https://huggingface.co/LiquidAI/LFM2.5-VL-450M-Extract" style={{padding: '0.35rem 0.7rem', borderRadius: '4px', fontSize: '0.85rem', fontWeight: 600, textDecoration: 'none', backgroundColor: '#fbbf24'}}><span style={{color: '#000'}}>HF</span></a>
  <a href="https://huggingface.co/LiquidAI/LFM2.5-VL-450M-Extract-GGUF" style={{padding: '0.35rem 0.7rem', borderRadius: '4px', fontSize: '0.85rem', fontWeight: 600, textDecoration: 'none', backgroundColor: '#60a5fa'}}><span style={{color: '#000'}}>GGUF</span></a>
</div>
...
<Card title="Edge Extraction" icon="microchip">
