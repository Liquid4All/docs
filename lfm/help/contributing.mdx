...
- Use relative links for internal pages: `/docs/gpu-inference/transformers`
- Use descriptive link text: "See the [inference guide](/docs/gpu-inference/transformers)" not "Click [here](/docs/gpu-inference/transformers)"
