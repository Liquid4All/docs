...
Parameter names and syntax vary by platform. See [Transformers](/docs/gpu-inference/transformers), [vLLM](/docs/gpu-inference/vllm), or [llama.cpp](/docs/on-device/llama-cpp) for details.
