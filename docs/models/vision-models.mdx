...
<Card title="LFM2.5-VL-1.6B" href="https://huggingface.co/LiquidAI/LFM2.5-VL-1.6B">
...
<Card title="LFM2-VL-3B" href="https://huggingface.co/LiquidAI/LFM2-VL-3B">
  3B

  Highest-capacity multimodal model with enhanced visual reasoning.
</Card>

<Card title="LFM2-VL-1.6B" href="https://huggingface.co/LiquidAI/LFM2-VL-1.6B">
  1.6B · <Badge shape="pill" color="gray">Deprecated</Badge>

  Use the new LFM2.5-VL-1.6B checkpoint instead.
</Card>

<Card title="LFM2-VL-450M" href="https://huggingface.co/LiquidAI/LFM2-VL-450M">
