...
<Tabs>
  ...
  <Tab title="Bundle Custom Models">
    ...
    **Compatibility Note:** The Model Bundling Service will work with any fine-tuned model, as long as the model architecture comes from a base model that is part of the LEAP model library.
    ...
    ![api-key-screenshot](/images/docs/tools/model-bundling/assets/images/api-keys-51242efd637d71dd5e7f4eb01555cd78.png)
...
* Check the [Bundle Creation](/docs/tools/model-bundling/bundle-creation) page for detailed command reference.
