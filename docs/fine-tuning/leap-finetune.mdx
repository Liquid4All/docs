...
2. **Convert** to edge-optimized format using the [Model Bundling Service](/docs/tools/model-bundling/quick-start)
3. **Deploy** to mobile devices using the [LEAP SDK](/docs/on-device/ios/ios-quick-start-guide)
