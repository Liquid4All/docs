...
* Learn how to expose structured JSON outputs with the [`@Generatable` macros](/docs/on-device/ios/constrained-generation).
* Wire up tools and external APIs with [Function Calling](/docs/on-device/ios/function-calling).
* Compare on-device and cloud behaviour in [Cloud AI Comparison](/docs/on-device/ios/cloud-ai-comparison).
...
[Edit this page](https://github.com/Liquid4All/docs/tree/main/docs/on-device/ios/ios-quick-start-guide.mdx)
