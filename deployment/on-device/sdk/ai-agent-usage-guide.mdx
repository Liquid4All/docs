...
<Tabs>
  ...
  <Tab title="JVM / Linux native / Windows native">
    ...
    - **Pin to 0.10.6 or newer** for Kotlin/Native — earlier 0.10.x releases (0.10.0, 0.10.1) have unresolved cinterop / linker issues that prevent producing a working executable; the fixes shipped in the 0.10.4.x point releases (SPM) and 0.10.6 (Android-SDK repo). See [Desktop & Native Platforms](./desktop-platforms).
  </Tab>
</Tabs>
