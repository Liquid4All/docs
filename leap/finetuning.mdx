...
| ------------- | ------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DPO (TRL)     | Preference alignment with Direct Preference Optimization (DPO) using TRL. | [<img src="https://unpkg.com/@lobehub/icons-static-png@1.55.0/light/colab-color.png" width={32} height={32} alt="colab-icon" />](https://colab.research.google.com/drive/1MQdsPxFHeZweGsNx4RH7Ia8lG8PiGE1t)                                           |
| SFT (TRL)     | Supervised Fine-Tuning (SFT) notebook with a LoRA adapter using TRL.      | [<img src="https://unpkg.com/@lobehub/icons-static-png@1.55.0/light/colab-color.png" width={32} height={32} alt="colab-icon" />](https://colab.research.google.com/drive/1j5Hk_SyBb2soUsuhU0eIEA9GwLNRnElF)                                           |
| SFT (Unsloth) | Supervised Fine-Tuning (SFT) notebook with a LoRA adapter using Unsloth.  | [<img src="https://unpkg.com/@lobehub/icons-static-png@1.55.0/light/colab-color.png" width={32} height={32} alt="colab-icon" />](<https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Liquid_LFM2_(1.2B)-Conversational.ipynb>) |
| SFT (Axolotl) | Supervised Fine-Tuning (SFT) notebook with a LoRA adapter using Axolotl.  | [<img src="https://unpkg.com/@lobehub/icons-static-png@1.55.0/light/colab-color.png" width={32} height={32} alt="colab-icon" />](https://colab.research.google.com/drive/155lr5-uYsOJmZfO6_QZPjbs8hA_v8S7t)                                           |
