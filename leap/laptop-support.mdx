...
| ----------------------- | ------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| Nvidia GPU              | llama-b6318-bin-win-cuda-12.4-x64.zip | [Download](https://github.com/ggml-org/llama.cpp/releases/download/b6318/llama-b6318-bin-win-cuda-12.4-x64.zip) |
| Intel GPU               | llama-b6318-bin-win-sycl-x64.zip      | [Download](https://github.com/ggml-org/llama.cpp/releases/download/b6318/llama-b6318-bin-win-sycl-x64.zip)      |
| AMD GPU                 | llama-b6318-bin-win-vulkan-x64.zip    | [Download](https://github.com/ggml-org/llama.cpp/releases/download/b6318/llama-b6318-bin-win-vulkan-x64.zip)    |
| Other GPU               | llama-b6318-bin-win-vulkan-x64.zip    | [Download](https://github.com/ggml-org/llama.cpp/releases/download/b6318/llama-b6318-bin-win-vulkan-x64.zip)    |
| Qualcomm Snapdragon CPU | llama-b6318-bin-win-cpu-arm64.zip     | [Download](https://github.com/ggml-org/llama.cpp/releases/download/b6318/llama-b6318-bin-win-cpu-arm64.zip)     |
| Other (CPU-only)        | llama-b6318-bin-win-cpu-x64.zip       | [Download](https://github.com/ggml-org/llama.cpp/releases/download/b6318/llama-b6318-bin-win-cpu-x64.zip)       |

**macOS**

| Hardware      | Binary Name                     | Download Link                                                                                             |
| ------------- | ------------------------------- | --------------------------------------------------------------------------------------------------------- |
| Intel         | llama-b6318-bin-macos-x64.zip   | [Download](https://github.com/ggml-org/llama.cpp/releases/download/b6318/llama-b6318-bin-macos-x64.zip)   |
| Apple Silicon | llama-b6318-bin-macos-arm64.zip | [Download](https://github.com/ggml-org/llama.cpp/releases/download/b6318/llama-b6318-bin-macos-arm64.zip) |

**Ubuntu**

| Hardware | Binary Name                           | Download Link                                                                                                   |
| -------- | ------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| GPU      | llama-b6318-bin-ubuntu-vulkan-x64.zip | [Download](https://github.com/ggml-org/llama.cpp/releases/download/b6318/llama-b6318-bin-ubuntu-vulkan-x64.zip) |
| CPU-only | llama-b6318-bin-ubuntu-x64.zip        | [Download](https://github.com/ggml-org/llama.cpp/releases/download/b6318/llama-b6318-bin-ubuntu-x64.zip)        |
