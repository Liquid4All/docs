...
<CardGroup>
  <Card title="🤖AndroidGet started with the LEAP Edge SDK for Android using Kotlin. Deploy models directly in your Android app." href="./android/android-quick-start-guide" />

  <Card title="🍎iOSGet started with the LEAP Edge SDK for iOS using Swift. Deploy models directly in your iOS app." href="./ios/ios-quick-start-guide" />
</CardGroup>
