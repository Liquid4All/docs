...
2. Download the JSON manifest file for the given combination of model and quantization, if it exists.
3. Download all model files referenced in the manifest.
4. Update the local manifest to use relative paths to the downloaded files.
