...
* 🤖 Android Edge SDK
  ...
  * Features
    ...
    * Added Model Downloader module to simplify model fetching in prototypes and development; see details [here](/leap/edge-sdk/android/utilities#model-downloader)
