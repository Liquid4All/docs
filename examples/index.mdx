...
<Card title="Satellite VLM Fine-Tuning" icon="satellite" href="/examples/laptop-examples/leonie-example">
  Fine-tune LFM2.5-VL-450M on satellite imagery tasks using leap-finetune, Modal, and VRSBench.
</Card>
