---
title: "Fine-Tune a Vision-Language Model on Satellite Imagery"
---
...
![Satellite imagery tasks: grounding, VQA, and captioning on an airport scene](/images/examples/customize-models/satellite-vlm/demo.png)

## Quickstart

1. **Install and authenticate** (run from `cookbook/examples/satellite-vlm/`):

   Modal provides serverless GPUs you pay for per second. New accounts include $30 of free credit, enough to run this example end to end. No local GPU required.
...
[![AI in Space Hackathon](/images/examples/customize-models/satellite-vlm/hackathon_banner.jpeg)](https://luma.com/n9cw58h0)
